...
- **PACKAGING**
  - C. Chen, F. Luo and Y. Kang, "A Review of SiC Power Module Packaging: Layout, Material System and Integration," CPPS Transactions on Power Electronics and Applications, vol. 2, no. 3, pp. 170-186, 2017 [PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=8118373)
  - [Application Note Wolfspeed PRD-09129](https://assets.wolfspeed.com/uploads/2025/05/Wolfspeed_PRD-09129_Mitigating_Package_Induced_Failures_Application_Note.pdf): Mitigating Package Induced Failures. Contains basic structural details of a high power module.
